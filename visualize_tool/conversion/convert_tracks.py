...
JSON_FILE = "data/AIC22_Track2_NL_Retrieval/test_tracks.json"
IMAGE_DIR = "data/meta/extracted_frames"
OUT_DIR = 'visualize_tool/track_vids/test'
...
def extract_tracks(image_dir, json_file, out_dir):
    ...
    for idx, track_id in enumerate(tqdm(track_ids)):
        ...
        # Init video writer
        FPS = 10
        outpath = osp.join(out_dir, str(idx) + '.webm')
    ...
    with open(osp.join(out_dir, 'test_order.json'), 'w') as f:
